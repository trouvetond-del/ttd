-- Fix: Add mover_price to contract financial data
-- This ensures the mover contract shows the mover's original quote price
-- while the client contract shows the client display price
